			...
			<AnimatePresence>
				{isOpen && (
					<motion.div
						...
						className='fixed inset-0 bg-light/80 backdrop-blur z-50 flex justify-center items-center px-4 border-t-4 border-primary'
					...
					>
						...
						>
							<div className='w-full h-full relative max-w-4xl mx-auto overflow-hidden '>
								<div className='h-full flex flex-col lg:p-4 text-dark gap-8 overflow-y-auto max-h-[100vh] pb-16 scrollbar-hide'>
